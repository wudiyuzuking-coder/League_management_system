...
def build():
    ...
    add_table(
        ...
        [
            [
                ...
                "注册登录、浏览赛季赛程、按俱乐部或轮次筛选比赛、查看票区票价和剩余连坐能力、选择票区和购票张数、提交订单、模拟支付、查看电子票、申请退票、查看订单记录。",
            ],
            [
                "俱乐部",
    ...
    add_table(
        ...
        ["功能编号", "功能名称", "功能说明"],
        [
            ["F01", "用户注册与登录", "用户通过手机号或账号密码注册登录；系统记录用户基础信息，并支持修改个人资料和密码。"],
    ...
    add_table(
        ...
        ["模块", "主要功能", "面向角色"],
        [
            ["用户端", "浏览赛程、查看俱乐部资料、查看比赛详情、选择票区购票、查看订单和电子票、提交退票申请。", "用户"],
