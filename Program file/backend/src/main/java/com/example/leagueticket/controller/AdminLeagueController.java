...
public class AdminLeagueController {
    ...
    @PostMapping("/seasons/{id}/registration/close") public Result<SeasonInfo> closeRegistration(@PathVariable Long id){return Result.success(lifecycleService.closeRegistration(id));}
