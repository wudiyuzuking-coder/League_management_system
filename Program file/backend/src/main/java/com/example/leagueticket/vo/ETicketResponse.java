...
public record ETicketResponse(Long ticketId,String ticketCode,Long orderId,Long itemId,String ticketStatus,
        ...
        LocalDateTime matchTime,String stadiumName,String zoneName,String rowNo,String seatNo,
        String passengerName,String passengerIdCard,BigDecimal ticketPrice) {}
