...
public class TicketController {
    ...
    @PostMapping("/api/matches/{matchId}/ticket-types/{ticketType}/seat-allocation/preview") public Result<SeatAllocationResponse> previewStandard(@PathVariable Long matchId,@PathVariable String ticketType,@Valid @RequestBody SeatAllocationRequest request){var zone=standardTicketZoneSelector.select(matchId,ticketType,request.ticketCount(),false);return Result.success(seatAllocateService.preview(zone.getMatchZoneId(),request.ticketCount()));}
}
