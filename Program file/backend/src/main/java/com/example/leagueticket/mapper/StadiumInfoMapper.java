...
public interface StadiumInfoMapper {
    String COLUMNS="stadium_id,stadium_name,city,address,capacity,layout_description layout_desc,venue_model,stadium_status";
    ...
    @Insert("INSERT INTO stadium_info(stadium_name,city,address,capacity,layout_description,venue_model,stadium_status) VALUES(#{stadiumName},#{city},#{address},#{capacity},#{layoutDesc},#{venueModel},'ACTIVE')") @Options(useGeneratedKeys=true,keyProperty="stadiumId") int insert(StadiumInfo stadium);
