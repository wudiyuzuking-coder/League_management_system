...
public record RefundResponse(Long refundId,String refundNo,Long orderId,String orderNo,Long applicantId,
        String username,BigDecimal refundAmount,BigDecimal refundRate,BigDecimal feeAmount,String processingMode,String reason,String refundStatus,LocalDateTime appliedAt,
