...
public interface StadiumZoneMapper {
    String COLUMNS="stadium_zone_id,stadium_id,zone_code,zone_name,zone_direction,ticket_type,sort_order sort_no,zone_status,description";
    ...
    @Insert("INSERT INTO stadium_zone(stadium_id,zone_code,zone_name,zone_direction,ticket_type,sort_order,zone_status,description) VALUES(#{stadiumId},#{zoneCode},#{zoneName},#{zoneDirection},#{ticketType},#{sortNo},'ACTIVE',#{description})") @Options(useGeneratedKeys=true,keyProperty="stadiumZoneId") int insert(StadiumZone zone);
