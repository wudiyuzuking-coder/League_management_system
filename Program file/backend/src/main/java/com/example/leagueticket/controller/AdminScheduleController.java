...
public class AdminScheduleController {
    ...
    @PostMapping("/seasons/{seasonId}/close-registration") public Result<ScheduleDetailResponse> closeRegistration(@PathVariable Long seasonId,@AuthenticationPrincipal AuthenticatedUser user){return Result.success(service.closeRegistrationAndPublishSchedule(seasonId,user.userId()));}
