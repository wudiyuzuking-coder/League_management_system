...
初始化账号
----------
- 系统管理员：手机号 13800000000，工号 0001，初始密码 123456。
- 四个俱乐部负责人：手机号依次为 13800000001、13800000002、13800000003、13800000004，初始密码均为 123456。
- 正式初始化不创建 USER，也不创建 EVENT_ADMIN；需要由系统管理员在页面中新增赛事管理员，普通用户可自行注册。
- 首次登录后建议立即修改默认密码 123456。
