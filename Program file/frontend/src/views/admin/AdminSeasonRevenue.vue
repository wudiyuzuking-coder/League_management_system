<script setup>
import {onMounted,ref} from 'vue';import {getSeasons} from '../../api/league';import {getSeasonRevenue} from '../../api/statistics'
...
onMounted(async()=>{seasons.value=(await getSeasons()).data;if(seasons.value.length){seasonId.value=seasons.value[0].seasonId;await load()}})
</script>
