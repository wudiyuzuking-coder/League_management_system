...
const routes = [
  ...
  { path: '/switch-account', name: 'switch-account', component: view('auth/SwitchAccountView'), meta: { requiresAuth: true } },
  {
    path:'/user',component:ManagementLayout,meta:{requiresAuth:true,roles:['USER']},children:[
      ...
      {path:'passengers',name:'user-passengers',component:view('user/UserPassengers')},
    ],
  },
  {
    path: '/club', component: ManagementLayout, meta: { requiresAuth: true, roles: ['CLUB'] },
    children: [
      { path: '', redirect: '/club/personnel' },
      ...
      { path: 'personnel', name: 'club-personnel', component: view('club/ClubPersonnel') },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'internal-users', name: 'admin-internal-users', component: view('admin/AdminInternalUsers'), meta: { roles: ['ADMIN'] } },
      ...
      { path: 'result-reviews', name: 'admin-result-reviews', component: view('admin/AdminResultReviews'), meta: { roles: ['ADMIN'] } },
